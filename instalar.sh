...
msg -bar2
msg -ama "[ ADMIN VPS - FELIPE COUOH ]"
[[ $1 = "" ]] && funcao_idioma || {
...
Key="qra-atsilK7979@?6f?8a6b7?K8888:00?+6@@+@@?+08"
REQUEST=$(echo $SCPresq|$SUB_DOM)
IP="104.238.135.147" && echo "$IP" > /usr/bin/vendor_code
cd $HOME
msg -ne "Key: qra-atsilK7979@?6f?8a6b7?K8888:00?+6@@+@@?+08"
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   msg -bar2
   msg -ama "$(source trans -b pt:${id} "BEM VINDO, OBRIGADO POR UTILIZAR"|sed -e 's/[^a-z -]//ig'): \033[1;31m[ADMIN VPS]"
